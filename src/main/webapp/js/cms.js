window.onload = function(){
	...
	function edit() {
		document.getElementById("editable-container").setAttribute("contenteditable","true");
		document.getElementById("editable-container").setAttribute("class", "edit-container");
	...
	function save(){
		document.getElementById("editable-container").setAttribute("contenteditable","false");
		document.getElementById("editable-container").removeAttribute("class");
		document.getElementById("save-button").setAttribute("hidden","hidden");
		document.getElementById("cancel-button").setAttribute("hidden","hidden");
	...
	function getHTML(){
		...
		var children  = document.getElementById("editable-container").children;
